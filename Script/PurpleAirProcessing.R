...
process_PA <- function(df, LocalTimeZone, platform_name) {
  df %>%
    ...
    mutate(
      # Calculate averages for PM1.0, PM2.5, PM10.0, and counts
      across(
        c(pm1_0_atm, pm2_5_atm, pm10_0_atm, p_0_3_um, p_0_5_um, p_1_0_um, p_2_5_um, p_5_0_um), #p_10_0_um_b was corrupted on much of our data, which is why it isn't included
    ...
    mutate(
      ...
      pm2_5_corr = ifelse(QC == "bad", NA_real_, pm2_5_corr),
      pm2_5_atm_avg = ifelse(QC == "bad", NA_real_, pm2_5_atm_avg),
      pm10_0_atm_avg = ifelse(QC == "bad", NA_real_, pm10_0_atm_avg),
      pm1_0_atm_avg = ifelse(QC == "bad", NA_real_, pm1_0_atm_avg),
      p_0_3_um_avg = ifelse(QC == "bad", NA_real_, p_0_3_um_avg),
      p_0_5_um_avg = ifelse(QC == "bad", NA_real_, p_0_5_um_avg),
      p_1_0_um_avg = ifelse(QC == "bad", NA_real_, p_1_0_um_avg),
      p_2_5_um_avg = ifelse(QC == "bad", NA_real_, p_2_5_um_avg),
      p_5_0_um_avg = ifelse(QC == "bad", NA_real_, p_5_0_um_avg),
      p_10_0_um = ifelse(QC == "bad", NA_real_, p_10_0_um),
      p_lt1.0_um = p_0_3_um_avg + p_0_5_um_avg + p_1_0_um_avg,
      p_lt2.5_um = p_0_3_um_avg + p_0_5_um_avg + p_1_0_um_avg + p_2_5_um_avg,
      p_lt5.0_um = p_0_3_um_avg + p_0_5_um_avg + p_1_0_um_avg + p_2_5_um_avg + p_5_0_um_avg,
      p_lt10.0_um = p_0_3_um_avg + p_0_5_um_avg + p_1_0_um_avg + p_2_5_um_avg + p_5_0_um_avg + p_5_0_um_avg,
      )
}
